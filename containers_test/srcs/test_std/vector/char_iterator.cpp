...
int main()
{
    ...
    std::vector<char>::const_iterator cit1(&c);
    std::vector<char>::const_iterator cit1bis(it1); //it1 must inherit
    std::vector<char>::const_iterator cit2(tab2);
    std::vector<char>::iterator  it2_neq; //enleve parenthese
    std::vector<char>::iterator::reference ref_it2 = *it2;
    std::vector<char>::iterator::pointer ref_it3 = &*it3;
    std::vector<char>::const_iterator::reference ref_cit2 = *cit2;
    std::vector<char>::const_iterator::pointer point_cit2 = &*cit2;
    ...
    *cit2++;
    ...
    std::vector<char>::const_reverse_iterator  citr;
    std::vector<char>::const_reverse_iterator  citr1(cit1);
    std::vector<char>::const_reverse_iterator  citr2(it2r);
    std::vector<char>::const_reverse_iterator  citr3(it3);
