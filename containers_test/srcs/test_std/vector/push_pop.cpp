...
template <typename T>
void    push(std::vector<T> &lst, T val)
{
...
template <typename T>
void    test_all(std::vector<T> lst, size_t del, size_t add, size_t add2, T val)
{
    std::vector<T> empty;
...
int main()
{
    ...
    std::vector<int>     lst(tab_int, tab_int + 28);
    std::vector<double>     lst1(tab_db, tab_db + 6);
    std::vector<char>     lst2(tab_char, tab_char + 1395);
    std::vector<std::string>     lst3(tab_str, tab_str + 12);
