...
template<typename T>
void cmp(typename std::vector<T>::iterator it1, typename std::vector<T>::iterator it2)
{
    typename std::vector<T>::const_iterator const_it1(it1);
    typename std::vector<T>::const_iterator const_it2(it2);
...
template<typename T>
void reverse_cmp(typename std::vector<T>::reverse_iterator it1, typename std::vector<T>::reverse_iterator it2)
{
    typename std::vector<T>::const_reverse_iterator const_it1(it1);
    typename std::vector<T>::const_reverse_iterator const_it2(it2);
...
void    test_all(T val, size_t size, T *tab, size_t size1, T val2, size_t size2)
{
    ...
    std::vector<T>   lst4(size1);
    std::vector<T>   lst5(size, val);
    std::vector<T>   tab_lst[] = {lst1, lst2, lst3, lst4, lst5};
