...
int main(int argc, char **argv)
{
    ...
    std::vector<void *> vec;
    std::vector<void *> vec1(0);
    std::vector<void *> vec2(67);
    std::vector<void *> vec3(811);
    std::vector<void *> vec4(21, tab);
    std::vector<void *> vec5(x, tab1);
    std::vector<void *> vec6(2973, tab2);
    std::vector<void *> vec7(60578, tab3);
    std::vector<void *> vec8(vec4);
    std::vector<void *> vec9(vec5);
    std::vector<void *> vec10(vec6);
    std::vector<void *> vec11(vec3);
