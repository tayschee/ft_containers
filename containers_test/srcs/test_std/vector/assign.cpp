...
template<typename T>
void print(std::vector<T> &vec, size_t x, size_t y, T *tab)
{
    size_t i;

    try
    {
        typename std::vector<T>::iterator beg(&tab[x]);
        typename std::vector<T>::iterator end(&tab[y]);
        vec.assign(beg, end);
        for(i = 0; 1; i++)
            std::cout << vec.at(i) << " ";
    }
...
template<typename T>
void print(std::vector<T> &vec, size_t x, const T &val)
{
    size_t i;
...
template<typename T>
void print(std::vector<T *> &vec, size_t x, T *val)
{
    size_t i;
    size_t j;
...
int main()
{
    ...
    int    tab14[] = {1, 0}; //2
    std::vector<int>::iterator beg1(tab12);
    std::vector<int>::iterator end1(&tab12[11]);
    ...
    std::vector<std::string>::iterator end3(&tab3[5]);
    ...
    std::vector<double> vec4(x4, -89.18);
