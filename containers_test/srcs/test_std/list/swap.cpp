...
template <typename T>
void            test_func(std::list<T> lst, std::list<T> lst_bis)
{
    typename std::list<T>::iterator beg_lst(lst.begin());
    typename std::list<T>::iterator beg_bis(lst_bis.begin());
...
template <typename T>
void            test_func1(std::list<T> lst, std::list<T> lst_bis)
{
    typename std::list<T>::iterator beg_lst(lst.begin());
    typename std::list<T>::iterator beg_bis(lst_bis.begin());
   
    std::swap(lst_bis, lst);
...
template <typename T>
std::list<T>        create(int size, const T &val, const T &val2, int nb)
{
    std::list<T>     lst(size, val);
