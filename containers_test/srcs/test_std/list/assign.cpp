...
template <typename T>
void    test(std::list<T>  &list, typename std::list<T>::iterator it_beg, typename std::list<T>::iterator it_end)
{
    size_t i;
    try
    {
...
void    test(std::list<struct a>  &list, typename std::list<struct a>::iterator it_beg, typename std::list<struct a>::iterator it_end)
{
    size_t i;
    try
    {
...
template <typename T>
void            test_assign(std::list<T> lst1, std::list<T> lst2)
{
    typename std::list<T>::iterator first(lst2.begin());
    typename std::list<T>::iterator last(lst2.end());

    typename std::list<T>::iterator beg(lst1.begin());
    typename std::list<T>::iterator end(lst1.end());
...
template <typename T>
void            test_assign(std::list<T> lst, size_t n, const T &val)
{
...
template <typename T>
std::list<T>        create_list(int size, const T &val)
{
...
template <typename T>
std::list<T>        create_list(int size, const T &val, int inter, const T &val2, int repeat)
{
    int i = 0;
    std::list<T>     lst(size, val);
...
template<typename T>
void    test_all1(const std::list<T> &lst, const std::list<T> &lst1, const std::list<T> &lst2, const std::list<T> &lst3)
{
    int i = 0;
    int j = 0;
