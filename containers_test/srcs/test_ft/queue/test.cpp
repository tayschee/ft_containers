...
void    test(const ft::queue<T, C> &s)
{
    std::cout << s.size();
    std::cout << s.empty();
}
...
template<class T, class C>
void    cmp(const ft::queue<T, C> &s1, const ft::queue<T, C> &s2)
{
    std::cout << (s1 == s2) << " ";
    std::cout << (s2 == s1) << " ";
    std::cout << (s1 != s2) << " ";
...
template<class T, class C>
void    pop(ft::queue<T, C> &s, size_t size)
{
    size_t i = 0;
    while (i < size)
    {
...
template<class T, class C>
void    push(ft::queue<T, C> &s, T *tab, size_t size)
{
    size_t i = 0;
    while (i < size)
    {
...
template<class T, class C>
void    test_all(ft::queue<T, C> s, size_t del1, T *tab, size_t size, size_t del2)
{
    test(s);
    pop(s, del1);
    test(s);
...
int main()
{
    ...
    ft::queue<int, ft::list<int> >      si1;
    ft::queue<int, ft::list<int> >      si2(lst);
    ...
    ft::queue<std::string, std::deque<std::string> >      ss1;
    ft::queue<std::string, std::deque<std::string> >      ss2(vec);
    ...
    ft::queue<char, ft::list<char> >      sc1(lstc1);
    ft::queue<char, ft::list<char> >      sc2(lstc2);
