...
template <typename T>
void            test_func(ft::list<T> lst, int (*func)(T, T))
{
...
void    test_all(T *tab, size_t size, T *tab1, size_t size1, T *tab2, size_t size2, T val, size_t size3)
{
    ...
    ft::list<T> lst1(create(tab1, size1));
    ft::list<T> lst2(create(tab2, size2));
    ft::list<T> lst3(size3, val);
    ft::list<T> lst4(1, val);
    ft::list<T> lst5;
