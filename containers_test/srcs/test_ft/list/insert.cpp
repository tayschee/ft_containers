...
template <typename T>
void            test_func(ft::list<T> &lst, size_t pos, T val)
{
...
template <typename T>
void            test_func(ft::list<T> &lst, size_t pos, size_t nb, T val)
{
    typename ft::list<T>::iterator it_beg(lst.begin());
    typename ft::list<T>::iterator old_it(lst.begin());
...
void            test_func(ft::list<T> &lst, size_t pos, It beg, It end)
{
    typename ft::list<T>::iterator it_beg(lst.begin());
    typename ft::list<T>::iterator old_it(lst.begin());
...
{
    size_t i = 0;
    typename ft::vector<T>::iterator it_beg(tab);
    typename ft::vector<T>::iterator it_end(&tab[end]);
    ft::list<T> lst_it(it_beg, it_end);
    ft::list<T> lst(size, val);
