...
template <typename T>
void            test_func(ft::list<T> &lst, ft::list<T> &lst2, size_t pos, size_t first, size_t last)
{
    typename ft::list<T>::iterator it_beg(lst.begin());
    typename ft::list<T>::iterator it_first(lst2.begin());
    typename ft::list<T>::iterator it_last(lst2.begin());
...
template <typename T>
void            test_func(ft::list<T> &lst, ft::list<T> &lst2, size_t pos, size_t pos2)
{
    typename ft::list<T>::iterator it_beg(lst.begin());
    typename ft::list<T>::iterator it_beg2(lst2.begin());
...
template <typename T>
void            test_func(ft::list<T> &lst, ft::list<T> &lst2, size_t pos)
{
    typename ft::list<T>::iterator it_beg(lst.begin());
...
{
    ft::list<T> lst(tab1, tab1 + size1);
    ft::list<T> lst2(tab2, tab2 + size2);
    ft::list<T> lst3(tab2, tab2 + size2);
