...
int main()
{
    ...
    ft::vector<int>::iterator end1(&tab1[i]);
    ft::vector<int>    vec1(beg1, end1);

    int    tab2[] = {1, 0};
    for (i = 0; tab2[i] != 0; ++i);
    ft::vector<int>::iterator beg2(tab2);
    ft::vector<int>::iterator end2(&tab2[i]);
    ft::vector<int>    vec2(beg2, end2);

    int    tab3[] = {0};
    for (i = 0; tab3[i] != 0; ++i);
    ft::vector<int>::iterator beg3(tab3);
    ft::vector<int>::iterator end3(&tab3[i]);
    ft::vector<int>    vec3(beg3, end3);
    ...
    for (i = 0; tab4[i] != 0; ++i);
    ft::vector<int>::const_iterator beg4(tab4);
    ft::vector<int>::const_iterator end4(&tab4[i]);
    ft::vector<int>    vec4(beg4, end4);

    int    tab5[] = {12, 35,124, 0};
    for (i = 0; tab5[i] != 0; ++i);
    ft::vector<int>::const_iterator beg5(tab5);
    ft::vector<int>::const_iterator end5(&tab5[i]);
    ft::vector<int>    vec5(beg5, end5);

    ft::vector<int>    vec6(12, 12);
