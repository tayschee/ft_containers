...
int main()
{
    ...
    for (i = 0; tab1[i] != 0; ++i);
    ft::vector<char>::iterator beg1(tab1);
    ft::vector<char>::iterator end1(&tab1[i]);
    ft::vector<char>    vec1(beg1, end1);

    char    tab2[] = "a";
    for (i = 0; tab2[i] != 0; ++i);
    ft::vector<char>::iterator beg2(tab2);
    ft::vector<char>::iterator end2(&tab2[i]);
    ft::vector<char>    vec2(beg2, end2);

    char    tab3[] = "";
    for (i = 0; tab3[i] != 0; ++i);
    ft::vector<char>::iterator beg3(tab3);
    ft::vector<char>::iterator end3(&tab3[i]);
    ft::vector<char>    vec3(beg3, end3);
    ...
    for (i = 0; tab4[i] != 0; ++i);
    ft::vector<char>::const_iterator beg4(tab4);
    ft::vector<char>::const_iterator end4(&tab4[i]);
    ft::vector<char>    vec4(beg4, end4);

    char    tab5[] = "const ok";
    for (i = 0; tab5[i] != 0; ++i);
    ft::vector<char>::const_iterator beg5(tab5);
    ft::vector<char>::const_iterator end5(&tab5[i]);
    ft::vector<char>    vec5(beg5, end5);

    ft::vector<char>    vec6(12, 12);
