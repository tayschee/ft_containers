...
int main(int argc, char **argv)
{
    ...
    ft::vector<std::string> vec1(0);
    ft::vector<std::string> vec2(106);
    ft::vector<std::string> vec3(50342);
    ft::vector<std::string> vec4(28, "texte");
    ft::vector<std::string> vec5(x, "little");
    ft::vector<std::string> vec6(4805, "a");
    ft::vector<std::string> vec7(456016, "l");
    ft::vector<std::string> vec8(vec4);
    ft::vector<std::string> vec9(vec5);
    ft::vector<std::string> vec10(vec6);
    ft::vector<std::string> vec11(vec3);
    //ft::vector<std::string> vec12(66, NULL); //indetermine
