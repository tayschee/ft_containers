...
int main(int argc, char **argv)
{
    ...
    ft::vector<int> vec2(17);
    ft::vector<int> vec3(90732);
    ft::vector<int> vec4(88, 12604);
    ft::vector<int> vec5(x, 6);
    ft::vector<int> vec6(2981, 871);
    ft::vector<int> vec7(571891, 673);
    ft::vector<int> vec8(vec4);
    ft::vector<int> vec9(vec5);
    ft::vector<int> vec10(vec6);
    ft::vector<int> vec11(vec3);
