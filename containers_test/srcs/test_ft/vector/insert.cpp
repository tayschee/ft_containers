...
template <typename T>
void    func(ft::vector<T> &lst, size_t pos, T val)
{
...
template <typename T>
void    func(ft::vector<T> &lst, size_t pos, size_t end_nb, T *tab)
{
    typename ft::vector<T>::iterator first(tab);
    typename ft::vector<T>::iterator last(tab + end_nb);
...
template <typename T>
void    func(ft::vector<T> &lst, size_t pos, size_t j, T val)
{
    typename ft::vector<T>::iterator it(lst.begin());
    typename ft::vector<T>::iterator beg(lst.begin());
    typename ft::vector<T>::iterator end(lst.end());
