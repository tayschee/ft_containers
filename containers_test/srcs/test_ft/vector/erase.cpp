...
template <typename T>
void    func(ft::vector<T> &lst, size_t pos)
{
    typename ft::vector<T>::iterator it(lst.begin());
...
template <typename T>
void    func(ft::vector<T> &lst, size_t pos, size_t end_nb)
{
    typename ft::vector<T>::iterator beg(lst.begin());
    typename ft::vector<T>::iterator first(lst.begin());
    typename ft::vector<T>::iterator last(lst.begin());
    typename ft::vector<T>::iterator ret;
...
void    test_all(T *tab, size_t size, size_t n, size_t n2)
{
    size_t i = 0;
    ft::vector<T>   lst(create(size, tab));
    ft::vector<T>   lst1(create(size, tab));
