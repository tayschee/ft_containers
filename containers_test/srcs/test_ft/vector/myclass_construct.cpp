...
int main(int argc, char **argv)
{
    ...
    size_t           x = 27;
    std::string     str = "abc";
    ft::vector<test<int> > vec;
    ft::vector<test<char> > vec1(0);
    ft::vector<test<double> >  vec2(99);
    ft::vector<test<std::string> > vec3(6541);
    ft::vector<test<double> > vec4(108, 10981.721);
    ft::vector<test<int> > vec5(x, 61);
    ft::vector<test<std::string> > vec6(2004, str);
    ft::vector<test<char> >  vec7(10245, ':');
    ft::vector<test<double> > vec8(vec4);
    ft::vector<test<int> > vec9(vec5);
    ft::vector<test<std::string> > vec10(vec6);
    ft::vector<test<std::string> > vec11(vec3);
