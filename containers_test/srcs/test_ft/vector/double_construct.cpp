...
int main(int argc, char **argv)
{
    ...
    ft::vector<double> vec1(0);
    ft::vector<double> vec2(81);
    ft::vector<double> vec3(8012);
    ft::vector<double> vec4(143, 12.901);
    ft::vector<double> vec5(x, 6);
    ft::vector<double> vec6(2973, 871.999);
    ft::vector<double> vec7(60578, 1.1111);
    ft::vector<double> vec8(vec4);
    ft::vector<double> vec9(vec5);
    ft::vector<double> vec10(vec6);
    ft::vector<double> vec11(vec3);
