...
int main(int argc, char **argv)
{
    ...
    ft::vector<char> vec2(90);
    ft::vector<char> vec3(16004);
    ft::vector<char> vec4(16, 'e');
    ft::vector<char> vec5(x, '6');
    ft::vector<char> vec6(1430, '[');
    ft::vector<char> vec7(456016, '{');
    ft::vector<char> vec8(vec4);
    ft::vector<char> vec9(vec5);
    ft::vector<char> vec10(vec6);
    ft::vector<char> vec11(vec3);
