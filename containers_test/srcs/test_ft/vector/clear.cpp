...
template <typename T>
void    test_all(T val, size_t x, T *tab, size_t size)
{
    size_t i = 0;
    ft::vector<T>   tmp;
...
int main()
{
    ...
    //std::cout << "ok\n";
    test_all(12, 612, tab_int, 28);
    test_all('c', 231, tab_char, 1395);
    test_all(12.94, 11, tab_db, 6);
    test_all(str1, 3, tab_str, 12);
}
