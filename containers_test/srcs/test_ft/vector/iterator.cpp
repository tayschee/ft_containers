...
void    func(ft::vector<T> &lst1)
{
    ...
    typename ft::vector<T>::const_iterator const_it(it);
...
{
    size_t i = 0;
    typename ft::vector<T>::reverse_iterator it(lst1.rend());
    typename ft::vector<T>::const_reverse_iterator const_it(it);
    typename ft::vector<T>::reverse_iterator beg(lst1.rend());
    typename ft::vector<T>::reverse_iterator end(lst1.rbegin());
...
int main()
{
    ...
    //ft::vector<int>     abc(tab_int, tab_int + 5);
    //func(abc);
