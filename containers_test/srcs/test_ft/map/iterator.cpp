...
template <typename K, typename T, typename C >
void    cmp(typename ft::map<K, T, C>::iterator it1, typename ft::map<K, T, C>::iterator it2)
{
    std::cout << (it1 == it1) << " ";
    std::cout << (it1 != it1) << " ";
    std::cout << (it2 == it2) << " ";
...
template <typename K, typename T, typename C >
void    cmp(typename ft::map<K, T, C>::iterator it1, typename ft::map<K, T, C>::const_iterator it2)
{
    std::cout << (it1 == it1) << " ";
    std::cout << (it1 != it1) << " ";
    std::cout << (it2 == it2) << " ";
...
template <typename K, typename T, typename C >
void    cmp(typename ft::map<K, T, C>::const_iterator it1, typename ft::map<K, T, C>::const_iterator it2)
{
    std::cout << (it1 == it1) << " ";
    std::cout << (it1 != it1) << " ";
    std::cout << (it2 == it2) << " ";
...
template <typename K, typename T, typename C >
void    cmp(typename ft::map<K, T, C>::reverse_iterator it1, typename ft::map<K, T, C>::reverse_iterator it2)
{
    std::cout << (it1 == it1) << " ";
    std::cout << (it1 != it1) << " ";
    std::cout << (it2 == it2) << " ";
...
template <typename K, typename T, typename C >
void    cmp(typename ft::map<K, T, C>::reverse_iterator it1, typename ft::map<K, T, C>::const_reverse_iterator it2)
{
    std::cout << (it1 == it1) << " ";
    std::cout << (it1 != it1) << " ";
    std::cout << (it2 == it2) << " ";
...
template <typename K, typename T, typename C >
void    cmp(typename ft::map<K, T, C>::const_reverse_iterator it1, typename ft::map<K, T, C>::const_reverse_iterator it2)
{
    std::cout << (it1 == it1) << " ";
    std::cout << (it1 != it1) << " ";
    std::cout << (it2 == it2) << " ";
...
template <typename K, typename T, typename C >
void    inc(typename ft::map<K, T, C>::iterator beg, typename ft::map<K, T, C>::iterator end)
{
    while (beg != end)
    {
        std::cout << (*beg++).first << " ";
...
template <typename K, typename T, typename C >
void    inc(typename ft::map<K, T, C>::const_iterator beg, typename ft::map<K, T, C>::const_iterator end)
{
    while (beg != end)
    {
        std::cout << (*beg++).first << " ";
...
template <typename K, typename T, typename C >
void    inc(typename ft::map<K, T, C>::reverse_iterator beg, typename ft::map<K, T, C>::reverse_iterator end)
{
    while (beg != end)
    {
        std::cout << (*beg--).first << " ";
...
template <typename K, typename T, typename C >
void    inc(typename ft::map<K, T, C>::const_reverse_iterator beg, typename ft::map<K, T, C>::const_reverse_iterator end)
{
    while (beg != end)
    {
        std::cout << (*beg--).first << " ";
...
{
    ft::map<K, T, C>    map1(tab1, tab1 + size1);
    ft::map<K, T, C>    map2(tab2, tab2 + size2);
    ft::map<K, T, C>    map3(tab3, tab3 + size3);
    const ft::map<K, T, C>    cmap1(tab1, tab1 + size1);
    const ft::map<K, T, C>    cmap2(tab2, tab2 + size2);
    const ft::map<K, T, C>    cmap3(tab3, tab3 + size3);

    ft::map<K, T, C>            tab[] = {map1, map2, map3};
    const ft::map<K, T, C>      ctab[] = {cmap1, cmap2, cmap3};
