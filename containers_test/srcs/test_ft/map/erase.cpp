...
template <typename K, typename T, typename C >
void    test_all(ft::pair<K, T> *tab1, size_t size1, T key)
{
    size_t i = 0;
...
int main()
{
    ...
    ft::pair<int, int>    i1(200, 0), i2(100, -3), i3(50, -2), i4(20, -1), i5(150, -1), i6(120, 3), i7(110, 4), i8(24, 5), i9(-4, 5), i10(-2, 1), i11(-1, 1), i12(18, 1), i13(20, 20);
