...
{
    size_t i = 0;
    ft::map<K, T, C> cpy(tab1, tab1 + size1);
    ft::map<K, T, C> empty;
...
template <typename K, typename T, typename C >
void    test_all(ft::pair<K, T> *tab1, size_t size1, size_t a)
{
    size_t i = 0;
    ft::map<K, T, C> cpy(tab1, tab1 + size1);
    ft::map<K, T, C> empty;
...
template <typename K, typename T, typename C >
void    test_all(ft::pair<K, T> *tab1, size_t size1, size_t a, size_t b)
{
    size_t i = 0;
    ft::map<K, T, C> cpy(tab1, tab1 + size1);
    ft::map<K, T, C> empty;
    typename ft::map<K, T, C>::iterator it(cpy.begin());
    typename ft::map<K, T, C>::iterator it1(cpy.begin());
