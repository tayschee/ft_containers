...
void    test_all(ft::pair<K, T> *tab1, size_t size1, K *key, size_t size_k)
{
    ...
    ft::pair<typename ft::map<K, T, C>::iterator, typename ft::map<K, T, C>::iterator> pair;
    ft::pair<typename ft::map<K, T, C>::const_iterator, typename ft::map<K, T, C>::const_iterator> cpair;
