...
{
    size_t i = 0;
    typename ft::pair<typename ft::map<K, T, C>::iterator, bool> p;
    ft::map<K, T, C> cpy;
...
template <typename K, typename T, typename C >
void    test_all1(ft::pair<K, T> *tab1, size_t size1)
{
    size_t i = 0;
    typename ft::map<K, T, C>::iterator p;
    ft::map<K, T, C> cpy;
...
template <typename K, typename T, typename C >
void    test_all2(ft::pair<K, T> *tab1, size_t size1, size_t pos_it)
{
    size_t i = 0;
    typename ft::map<K, T, C>::iterator p;
