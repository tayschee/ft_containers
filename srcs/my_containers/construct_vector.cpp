...
int main(int argc, char **v)
{
    ...
    ft::vector<int> vec_int_0_3(0, 3);
    ft::vector<int> vec_int_0(0);
    ft::vector<int> vec_int_2_3(2, 3);
    ft::vector<int> vec_int_8_6(8, 6);
    ft::vector<int> vec_int_4(4);
    ft::vector<int> vec_int_8000000(800000);
    ft::vector<int> vec_int_12349_intmax(12349, 2147483647);
    ...
    ft::vector<char> vec_char_0_9(0, 'c');
    ft::vector<char> vec_char_0(0);
    ft::vector<char> vec_char_4_c(4, 'c');
    ft::vector<char> vec_char_12_e(12, 'e');
    ft::vector<char> vec_char_90(90);
    ft::vector<char> vec_char_16004(16004);
    ft::vector<char> vec_char_456012_(456012, '{');
    ...
    ft::vector<std::string> vec_str1(0, "salami");
    ft::vector<std::string> vec_str2(0);
    ft::vector<std::string> vec_str3(9, "orang outan");
    ft::vector<std::string> vec_str4(14, "marsupilami");
    ft::vector<std::string> vec_str5(112);
    ft::vector<std::string> vec_str6(8080);
    ft::vector<std::string> vec_str7(456012, "ca on s'en fout");
    ...
    ft::vector<double> vec_double1(0, 12.12);
    ft::vector<double> vec_double2(0);
    ft::vector<double> vec_double3(9, 128.43);
    ft::vector<double> vec_double4(14, 16.3);
    ft::vector<double> vec_double5(112);
    ft::vector<double> vec_double6(8080);
    ft::vector<double> vec_double7(456012, 16800.653);
    ...
    ft::vector<void *> vec_void;
    ft::vector<void *> vec_void1(0, test);
    ft::vector<void *> vec_void2(0);
    ft::vector<void *> vec_void3(93, NULL);
    ft::vector<void *> vec_void4(709, test1);
    ft::vector<void *> vec_void5(1187);
    ft::vector<void *> vec_void6(808043);
    ft::vector<void *> vec_void7(4560123, test2);
